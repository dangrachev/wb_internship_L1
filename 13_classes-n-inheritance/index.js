/*
* В этом примере создан базовый класс `Shape`, который имеет абстрактные методы `calculateArea()` и `calculatePerimeter()`.
* Затем созданы подклассы `Rectangle`, `Circle` и `Triangle`,
* в которых переопределены эти методы для каждой фигуры, в соответствии с их уникальными формулами для расчета площади и периметра.
* */
